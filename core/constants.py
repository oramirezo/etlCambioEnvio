...
SERVER_LIMIT_DATA_LEN = 1000
LIMIT_LOCAL=100
SPARK_LT_DRIVER = '/data/users/oscar_ramirez/etlIncidencias/core/sparkDriver.py'

PATH_LOCAL_TEMP_LT = '/data/users/oscar_ramirez/aficobranza/cobranza/urgentes/incidencias/lt'
...
PATH_LOCAL_TEMP_LA = '/data/users/oscar_ramirez/aficobranza/cobranza/urgentes/incidencias/la'
#PATH_LOCAL_TEMP_LA_WIN = 'C:/Users/hrodriguez/Documents/imss/la'
PATH_LOCAL_TEMP_LA_WIN = 'C:/proyectos/imss/cambioEnvio/la'
ERROR_TYPE = {
            '0': '',
            '0.0': '',
